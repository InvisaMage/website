...
//Father
		...
		document.getElementById("name").innerHTML =
		"Hello father and welcome back to my Web App."
//Mother
		if (name == "Connie" || (name == "connie") || (name == "Mom") || (name == "mom") || (name == "Mother") || (name == "mother"))
		document.getElementById("name").innerHTML =
		"Hello mother and welcome back to my Web App."
//Emily - Audio
...
//Girls
		...
		document.getElementById("name").innerHTML =
		"Hello miss and welcome back to my Web App."
//Rachel
		if (name == "Rachel" || (name == "rachel"))
		document.getElementById("name").innerHTML =
		"Hello <a class='definition' data-toggle='tooltip' data-placement='top' title='An endangered subspecies of humans which are incapable of reproducing.'>femake</a> and welcome back to my Web App."
//Tony
		if (name == "Tony" || (name == "tony"))
		document.getElementById("name").innerHTML =
		"Hello <a class='definition' data-toggle='tooltip' data-placement='top' title='An endangered subspecies of humans which are incapable of reproducing.'>femake</a> lover and welcome back to my Web App."
//Joe
		if (name == "Joe" || (name == "joe") || (name == "Joey") || (name == "joey"))
		document.getElementById("name").innerHTML =
		"Hello nerd and welcome back to my Web App."
//Brian
		if (name == "Brian" || (name == "brian"))
		document.getElementById("name").innerHTML =
		"Hello brother and welcome back to my Web App."
//David - Audio
...
//Reset
		...
		document.getElementById("name").innerHTML =
		"Welcome to <a class='definition' data-toggle='tooltip' data-placement='top' title='A 17 year old human male who likes web technologies and assorted games.'>InvisaMage</a>'s Web App."
//No name - Audio
