...
// Contact Modal
	...
	$('#modal-contact').load('ajax/contact.html #ajax-contact'); $('#modal-contact').modal();

// Donate Modal
	if (search == "Donate" || (search == "donate") || (search == "Money") || (search == "money"))
	$('#modal-donate').load('ajax/donate.html #ajax-donate'); $('#modal-donate').modal();
...
// Stats Modal
	...
	$('#modal-stats').load('ajax/stats.html #ajax-stats'); $('#modal-stats').modal();
