...
//Default
		...
		"Hello " + name + " and welcome to <a class=link title=About href=m-about.html#InvisaMage>InvisaMage</a>'s Mobile optimized Website!.<br>I hope you enjoy your stay."
//Creator Message
		if (name == "InvisaMage" || (name == "invisamage") || (name == "Travis") || (name == "travis"))
		document.getElementById("name").innerHTML =
		"Hello creator and welcome back to your Mobile optimized Website!<br>Here are some links I thought you might like.<br><br><span class='homeSection'><h3>Links</h3><a class=link title='Repository' href=https://github.com/>GitHub</a><br><a class=link title='Online IDE' href=https://ide.c9.io>Cloud9</a><br><a class=link title='Telegram Web Client' href=https://web.telegram.org/>Telegram Web</a></span>"
//Friends
...
//Rachel
		...
		document.getElementById("name").innerHTML =
		"Hello <span class='hint--bottom' data-hint='An endangered subspecies of humans which are incapable of reproducing.'><a class='link' id='help'>femake</a></span> and welcome back to my Mobile optimized Website!"
//Tony
		if (name == "Tony" || (name == "tony"))
		document.getElementById("name").innerHTML =
		"Hello <span class='hint--bottom' data-hint='An endangered subspecies of humans which are incapable of reproducing.'><a class='link' id='help'>femake</a></span> lover and welcome back to my Mobile optimized Website!"
//Joe
...
//Reset
		...
		document.getElementById("name").innerHTML =
		"Welcome to <a class='link' title='About' href='m-about.html#InvisaMage'>InvisaMage</a>'s Mobile optimized Website!"
//No name - Audio
