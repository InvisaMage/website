...
function namePrompt()
{
	...
	if (name != null)
	{
		...
		document.getElementById("name").innerHTML =
		"Hello father and welcome to my Mobile optimized Website!"
		
		if (name == "Connie" || (name == "connie") || (name == "Mom") || (name == "mom") || (name == "Mother") || (name == "mother"))
		document.getElementById("name").innerHTML =
		"Hello mother and welcome to my Mobile optimized Website!"
		
		if (name == "Kim" || (name == "kim") || (name == "Emily") || (name == "emily"))
		document.getElementById("name").innerHTML =
		"Hello miss and welcome to my Mobile optimized Website!"
		
		if (name == "Rachel" || (name == "rachel"))
		document.getElementById("name").innerHTML =
		"Hello femake and welcome to my Mobile optimized Website!"
		
		if (name == "Brian" || (name == "brian"))
		document.getElementById("name").innerHTML =
		"Hello brother and welcome to my Mobile optimized Website!"
		...
		document.getElementById("name").innerHTML =
		"Your name goes in that box but anyway, welcome to <a class=link title=About href=m-about.html#InvisaMage>InvisaMage</a>'s Mobile optimized Website!"
	}
}