...
//Emily - Audio
		...
		document.getElementById("name").innerHTML =
		"Hello miss and welcome back to my Website.<br><br><span class='homeSection'><h2>You Are The Woman</h2><audio controls autoplay><source src='./source/audio/woman.mp3' type='audio/mpeg'><source src='https://www.googledrive.com/host/0B29-yEHUjNU3a1BhczlZS3ZyLUU' type='audio/mpeg'></audio></span>"
//Kim
...
//David - Audio
		...
		document.getElementById("name").innerHTML =
		"Tell me David, what's the answer?<br><br><span class='homeSection'><h2>Remember David</h2><audio controls autoplay><source src='./source/audio/david.mp3' type='audio/mpeg'><source src='https://www.googledrive.com/host/0B29-yEHUjNU3Y1lKNkFaUHZIRFU' type='audio/mpeg'></audio></span>"
//Jenny - Audio
		if (name == "Jenny" || (name == "jenny"))
		document.getElementById("name").innerHTML =
		"Jenny, I've got your number.<br>867-5309<br><br><span class='homeSection'><h2>867-5309/Jenny</h2><audio controls autoplay><source src='./source/audio/jenny.mp3' type='audio/mpeg'><source src='https://www.googledrive.com/host/0B29-yEHUjNU3Znk3bWswQWpIaEE' type='audio/mpeg'></audio></span>"
//Jenny
...
//Stacy - Audio
		...
		document.getElementById("name").innerHTML =
		"Stacy, your mom has got it going on.<br><br><span class='homeSection'><h2>Stacy's Mom</h2><audio controls autoplay><source src='./source/audio/stacy.mp3' type='audio/mpeg'><source src='https://www.googledrive.com/host/0B29-yEHUjNU3aE1mMXhzXzNJNFU' type='audio/mpeg'></audio></span>"
//Jessie - Audio
		if (name == "Jessie" || (name == "jessie"))
		document.getElementById("name").innerHTML =
		"Why can't I find a woman like that?<br><br><span class='homeSection'><h2>Jessie's Girl</h2><audio controls autoplay><source src='./source/audio/jessie.mp3' type='audio/mpeg'><source src='https://www.googledrive.com/host/0B29-yEHUjNU3RjJaVkoxdzVTTjg' type='audio/mpeg'></audio></span>"
//Leah - Audio
		if (name == "Leah" || (name == "leah"))
		document.getElementById("name").innerHTML =
		"Oh hey Leah. Look, it's your favourite song.<br><br><span class='homeSection'><h2>Ah Leah</h2><audio controls autoplay><source src='./source/audio/leah.mp3' type='audio/mpeg'><source src='https://www.googledrive.com/host/0B29-yEHUjNU3WHl4a2xNSDBjRGc' type='audio/mpeg'></audio></span>"
//Jesus
