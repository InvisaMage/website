...
//Default
		...
		"Hello " + name + " and welcome to <span class='hint--bottom' data-hint='A 16 year old human male who likes web technologies and assorted games.'><a class='definition'>InvisaMage</a></span>'s Mobile optimized Website!.<br>I hope you enjoy your stay."
//Creator Message
		if (name == "InvisaMage" || (name == "invisamage") || (name == "Travis") || (name == "travis"))
		document.getElementById("name").innerHTML =
		"Hello creator and welcome back to your Mobile optimized Website!<br>Here are some links I thought you might like.<br><br><span class='homeSection'><h3>Links</h3><span class='hint--right' data-hint='Repository'><a class='link' href='https://github.com/'>GitHub</a></span><br><span class='hint--right' data-hint='Online IDE'><a class='link' href='https://ide.c9.io'>Cloud9</a></span><br><span class='hint--right' data-hint='Telegram Web Client'><a class='link' href='https://web.telegram.org/'>Telegram Web</a></span>"
//Friends
		if (name == "Matt" || (name == "matt") || (name == "Matthew") || (name == "matthew") || (name == "Tanner") || (name == "tanner") || (name == "Carson") || (name == "carson") || (name == "Chris") || (name == "chris"))
		document.getElementById("name").innerHTML =
		"Hello good friend and welcome back to my Mobile optimized Website!"
//Kevin - Host
		if (name == "Kevin" || (name == "kevin"))
		document.getElementById("name").innerHTML =
		"Hello good friend and welcome back to my Mobile optimized Website!<br>Thanks for hosting.<br><br><a class=link title=Host href=http://www.chaoswebs.cf/>http://www.chaoswebs.cf/</a>"
//Father
		if (name == "Dan" || (name == "dan") || (name == "Daniel") || (name == "daniel") || (name == "Dad") || (name == "dad") || (name == "Father") || (name == "father"))
		document.getElementById("name").innerHTML =
		"Hello father and welcome back to my Mobile optimized Website!"
//Mother
		if (name == "Connie" || (name == "connie") || (name == "Mom") || (name == "mom") || (name == "Mother") || (name == "mother"))
		document.getElementById("name").innerHTML =
		"Hello mother and welcome back to my Mobile optimized Website!"
//Emily - Audio
		if (name == "Emily" || (name == "emily"))
		document.getElementById("name").innerHTML =
		"Hello miss and welcome back to my Mobile optimized Website.<br><br><span class='homeSection'><h2>You Are The Woman</h2><audio controls autoplay><source src='./audio/woman.mp3' type='audio/mpeg'><source src='https://www.googledrive.com/host/0B29-yEHUjNU3a1BhczlZS3ZyLUU' type='audio/mpeg'></audio></span>"
//Kim
		if (name == "Kim" || (name == "kim"))
		document.getElementById("name").innerHTML =
		"Hello miss and welcome back to my Mobile optimized Website."
//Rachel
		if (name == "Rachel" || (name == "rachel"))
		document.getElementById("name").innerHTML =
		"Hello <span class='hint--bottom' data-hint='An endangered subspecies of humans which are incapable of reproducing.'><a class='definition' id='help'>femake</a></span> and welcome back to my Mobile optimized Website!"
//Tony
		if (name == "Tony" || (name == "tony"))
		document.getElementById("name").innerHTML =
		"Hello <span class='hint--bottom' data-hint='An endangered subspecies of humans which are incapable of reproducing.'><a class='definition' id='help'>femake</a></span> lover and welcome back to my Mobile optimized Website!"
//Joe
...
//Brian
		...
		document.getElementById("name").innerHTML =
		"Hello brother and welcome back to my Mobile optimized Website!"
//David - Audio
...
//Jessie - Audio
		...
		document.getElementById("name").innerHTML =
		"Why can't I find a woman like that?<br><br><span class='homeSection'><h2>Jessie's Girl</h2><audio controls autoplay><source src='./audio/jessie.mp3' type='audio/mpeg'></audio></span>"
//Leah - Audio
...
//Reset
		...
		document.getElementById("name").innerHTML =
		"Welcome to <span class='hint--bottom' data-hint='A 16 year old human male who likes web technologies and assorted games.'><a class='definition'>InvisaMage</a></span>'s Mobile optimized Website!"
//No name - Audio
		if (name == "" || (name == " ") || (name == "undefined"))
		document.getElementById("name").innerHTML =
		"Your name goes in that box but, welcome to <span class='hint--bottom--left' data-hint='A 16 year old human male who likes web technologies and assorted games.'><a class='definition'>InvisaMage</a></span>'s Mobile optimized Website!<br><br><span class='homeSection'><h2>What's Your Name</h2><audio controls autoplay><source src='./audio/name.mp3' type='audio/mpeg'><source src='https://www.googledrive.com/host/0B29-yEHUjNU3OGducF9kRVU1dFE' type='audio/mpeg'></audio></span>"
	}
}
